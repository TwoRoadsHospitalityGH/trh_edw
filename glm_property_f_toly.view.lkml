view: glm_property_f_toly {
  ...
  measure: occupied_room_pct_toly_v {
    ...
    description: "Actual - LY"
    type: number
    sql: utl..udf_divide( ${glm_property_f_ty.occupied_room_pct} - ${glm_property_f_ly.occupied_room_pct} );;
  ...
  measure: adr_amt_toly_v {
    ...
    description: "Actual - LY"
    type: number
    sql: utl..udf_divide( ${glm_property_f_ty.adr_amt} - ${glm_property_f_ly.adr_amt} );;
    value_format_name: decimal_2
  }
  ...
  measure: adr_transient_amt_toly_v {
    ...
    description: "Actual - LY"
    type: number
    sql: utl..udf_divide( ${glm_property_f_ty.adr_transient_amt} - ${glm_property_f_ly.adr_transient_amt} );;
    value_format_name: decimal_2
  }
  ...
  measure: adr_group_amt_toly_v {
    ...
    description: "Actual - LY"
    type: number
    sql: utl..udf_divide( ${glm_property_f_ty.adr_group_amt} - ${glm_property_f_ly.adr_group_amt} );;
    value_format_name: decimal_2
  }
  ...
  measure: room_night_transient_pct_toly_v {
    ...
    description: "Actual - LY"
    type: number
    sql: utl..udf_divide( ${glm_property_f_ty.room_night_transient_pct} - ${glm_property_f_ly.room_night_transient_pct} );;
    value_format_name: percent_1
  }
  ...
  measure: room_night_group_pct_toly_v {
    ...
    description: "Actual - LY"
    type: number
    sql: utl..udf_divide( ${glm_property_f_ty.room_night_group_pct} - ${glm_property_f_ly.room_night_group_pct} );;
    value_format_name: percent_1
  }
